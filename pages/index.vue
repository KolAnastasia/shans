<template>
  <section>
    ...
    <div class="catalog-szr-wrap">
      <div class="container">
        <div class="catalog-szr-title-wr">
          <div class="catalog-szr-title">Продукция</div>
          <div class="catalog-szr-title_btn-wr">
            <a href="#" class="catalog-szr-title_btn">
              <svg
                width="26"
                height="26"
                viewBox="0 0 26 26"
        ...
        <div class="catalog-filter-main-wr">
          <div class="catalog-filter-wr">
            ...
            <div class="catalog-filter-reset">
              ...
              >
                <path
                  d="M15.1475 5.96665C13.4716 4.25806 11.2433 3.31708 8.8732 3.31708H7.57231L9.66029 1.18314L8.49692 0L4.43039 4.15603L8.44385 8.31619L9.61538 7.14146L7.542 4.9923H8.8732C12.8598 4.9923 16.1032 8.29892 16.1032 12.3634C16.1032 16.4278 12.8598 19.7344 8.8732 19.7344C4.88656 19.7344 1.64317 16.4278 1.64317 12.3632V11.5256L0 11.5258V12.3634C0 14.7797 0.922975 17.0515 2.59891 18.7601C4.27481 20.4687 6.50311 21.4097 8.8732 21.4097C11.2433 21.4097 13.4716 20.4687 15.1475 18.7601C16.8234 17.0514 17.7464 14.7797 17.7464 12.3634C17.7464 9.94705 16.8234 7.67528 15.1475 5.96665Z"
                  fill="#78BE20"
                />
              </svg> Сбросить
            </div>
          </div>
          <!-- <div class="catalog-filter-wr_btn-wr"> 
             <div class="catalog-filter-wr_btn-prev catalog-filter-wr_btn"> 
              <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 5.5H2M2 5.5L6.50783 1M2 5.5L6.50783 10" stroke="#9E9E9E" stroke-width="2"/>
              </svg>

             </div> 
              <div class="catalog-filter-wr_btn catalog-filter-wr_btn-next"> 
                <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 5.5H12M12 5.5L7.49217 1M12 5.5L7.49217 10" stroke="#9E9E9E" stroke-width="2"/>
                </svg>
             </div> 
          </div>-->
        </div>
    ...
    <div class="main-catalog-plant-wr">
      <div class="container">
        <div class="catalog-plants-title">Программы защиты растений</div>
        <app-catalogplants></app-catalogplants>
      </div>
    </div>
    <div class="main-news-wr">
      <div class="container"> 
        <div class="catalog-plants-title">Пресс-центр </div>
        <app-news> </app-news>  
      </div> 
    </div>
    ...
    <div class="main_trust">
      <div class="container">
        <div class="main_trust-wr">
          <div class="main_trust_subtitle">Нам доверяют</div>
          <div class="main_trust_content">
            <slick-slide ref="slick" :options="slickOptions" class="slider">
...
import appCatalogszr from "@/components/main-page/catalog-szr.vue";
import appCatalogplants from "@/components/main-page/catalog-plants.vue";
...
import appNews from "@/components/main-page/news.vue";
...
.main_desc 
  ...
  &-wr 
    background-image: url("../assets/desc-decoration-line.svg")
...
.catalog-filter-wr_btn-wr
  display: flex 
  align-items: center

.catalog-filter-wr_btn-next 
  margin-left: 56px
...
.main-catalog-plant-wr 
  background-color: #F9F9F9
  padding: 100px 0
  width: 100% 
  overflow: hidden

.catalog-plants-title 
  font-weight: 800
  font-size: 36px
  line-height: 43px
  text-transform: uppercase
